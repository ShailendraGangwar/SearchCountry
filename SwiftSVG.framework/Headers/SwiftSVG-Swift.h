...
/// Convenience initalizer that synchronously parses a single path string and returns a <code>CAShapeLayer</code>
/// \param pathString The path <code>d</code> string to parse.
///
...
/// :nodoc:
@property (nonatomic, copy) void (^ _Nullable completionBlock)(SVGLayer * _Nonnull);
/// The <code>SVGLayer</code> that will contain all of the SVG’s sublayers
@property (nonatomic, strong) SVGLayer * _Nonnull containerLayer;
...
@property (nonatomic, readonly, strong) SVGLayer * _Nullable svgLayerCopy;
@end
...
///
- (nonnull instancetype)initWithPathString:(NSString * _Nonnull)pathString;
+ (UIBezierPath * _Nullable)pathWithSVGURL:(NSURL * _Nonnull)SVGURL SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated. If you want to parse a single path, instantiate a new instance of SVGPath using the SVGPath(singlePathString:) initializer and pass the path string.");
@end
...
/// seealso:
/// See here for all the colors: <a href="https://www.w3.org/TR/css3-color/#svg-color">https://www.w3.org/TR/css3-color/#svg-color</a>
...
/// Convenience initializer that instantiates a new <code>UIView</code> instance with a single path <code>d</code> string. The path will be parsed synchronously.
/// \code
/// let view = UIView(pathString: "M20 30 L30 10 l10 10")
///
/// \endcode\param pathString The path <code>d</code> string to parse.
///
- (nonnull instancetype)initWithPathString:(NSString * _Nonnull)pathString;
@end
